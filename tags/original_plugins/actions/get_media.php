...
if (in_array($collection_name,$public_access_collections)) {
	serveFile($collection_name,$size,$filename,$download,$media_conf);
	exit;
}
...
function serveFile($collection_name,$size,$filename,$download,$media_conf) {
