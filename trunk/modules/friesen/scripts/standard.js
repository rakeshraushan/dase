...
function getHtml(url,elem_id,my_func) {
	document.getElementById(elem_id).innerHTML = '<select><option>Select Topic by Keyword</option></select>';
...
function getKeywords2() {
	var url = 'service/getKeywords2.php';
	getHtml(url,'keywords_target2',prepareKwSelect2);
	return false;
}

function prepareKwSelect2() {
	var kwform = document.getElementById('kwform2');
	var kw_select = document.getElementById('kw_select2');
	kw_select.onchange = function() {
		kwform.submit();
	}
}
