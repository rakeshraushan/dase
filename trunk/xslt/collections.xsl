...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
			...
			<body>
				...
				<div class="footer">
					Got a UT EID? <a href="" class="alert">Log In!</a>
					| <a href="action/quit_cb">Return to DASE</a>
					| <a href="action/select_admin_collection">Collection Builder</a>
					| <a href="apps/help" target="_blank" id="helpModule">FAQ</a> 
	...
	<xsl:template match="collections">
		<h1>Dase Collections (<xsl:value-of select="@count"/>)</h1>
		<xsl:apply-templates/>
	</xsl:template>
